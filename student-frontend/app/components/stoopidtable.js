    ...
    return (
        <div className={styles.main_Component_styler}>
            ...
            <div className={styles.tag_holder}>
                ...
                <button
                    className={`${styles.tag} ${activeTag === "islam" ? styles.active_tag : ""
                        }`}
                ...
                <button
                    className={`${styles.tag} ${activeTag === "Christianity" ? styles.active_tag : ""
                        }`}
                ...
                <button
                    className={`${styles.tag} ${activeTag === "Judaism" ? styles.active_tag : ""
                        }`}
                        ...
                        <React.Fragment key={index}>
                            ...
                            >
                                <td className={styles.table_maincell}>
                                    ...
                                    <div
                                        className={`${styles.stoopid_box} ${activeMainCell === index ? styles.flipped : ""
                                            }`}
                                    ></div>
                                </td>
                            </tr>
