...
When(
	"I will see the newly added question with text 'SX Testing Question'",
	async function () {
		return true;
	}
);
...
Then(
	"I will see the newly added answer with text 'SX Testing Answer'",
	async function () {
		return true;
	}
);
...
When("I see the question with text 'SX Testing Question'", async function () {
	return true;
});
