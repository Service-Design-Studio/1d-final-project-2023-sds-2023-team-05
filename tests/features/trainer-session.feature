Feature: Trainer Creating Sessions
    ...
    #     Given I am on the questions page
    #     When I click on the checkbox to select the question with "What is the concept of sin in Christianity?"
    #     When I click on the checkbox to select the question with "What is the role of mindfulness in Buddhism?"
    #     When I click on the checkbox to select the question with "What is the concept of the Ummah in Islam?"
